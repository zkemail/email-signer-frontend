...
import { createWalletClient, custom, createPublicClient, http, parseEther, parseAbi } from 'viem';
...
export default function WalletConnect({
    ...
    const [showAccountCodeConfirmation, setShowAccountCodeConfirmation] = useState(false);

    // Contract addresses
    const [emailSignerAddress, setEmailSignerAddress] = useState<string | null>(null);
    ...
    const connectWallet = async () => {
        ...
        try {
            ...
            if (accounts.length > 0) {
                ...
                addLog(`Connected to wallet: ${accounts[0].substring(0, 6)}...${accounts[0].substring(accounts[0].length - 4)}`);
            ...
            return (
                <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-4">
                    ...
                    <p className="text-sm mb-4">
                        We found an existing account code for this email address. Would you like to use it or create a new one?
                    </p>
            ...
            case 'connect':
                return (
                    <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-4">
                        ...
                        <p className="text-sm mb-4">
                            To get started, please connect your Ethereum wallet. This will be one of the owners of your multisig Safe.
                        </p>
                        <button
                            onClick={connectWallet}
                            disabled={isLoading}
                            className={`w-full px-4 py-2 rounded-md text-white ${isLoading ? "bg-blue-400" : "bg-blue-600 hover:bg-blue-700"}`}
                        >
            ...
            case 'email':
                return (
                    <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-4">
                        ...
                        <p className="text-sm mb-4">
                            Provide your email address which will be used as the second authorization method for your multisig Safe.
                        </p>
                        <form onSubmit={handleEmailSubmit} className="space-y-4">
                            ...
                            <button
                                ...
                                className={`w-full px-4 py-2 rounded-md text-white ${isLoading || !email ? "bg-blue-400" : "bg-blue-600 hover:bg-blue-700"}`}
                            >
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-4">
                        ...
                        <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md mb-4">
                            <p className="text-yellow-800 dark:text-yellow-300 text-sm font-medium">
                                Important: Save this account code securely! You'll need it to authorize operations with your email.
                            </p>
                        </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-4">
                        <div className="mb-4 text-center">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                You've successfully set up your email signer and Safe account.
                            </p>
                        </div>
                        ...
                        <div className="space-y-3 mb-4">
                            <div>
                                ...
                                <a href={`https://sepolia.etherscan.io/address/${emailSignerAddress}`} target="_blank" rel="noopener noreferrer"
                            ...
                            <div>
                                ...
                                <a href={`https://sepolia.etherscan.io/address/${safeAddress}`} target="_blank" rel="noopener noreferrer"
                                    className="text-blue-600 hover:underline dark:text-blue-400 text-xs mt-1 inline-block">
                                    View on Etherscan
                                </a>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-xs text-red-600 dark:text-red-400 mt-1">
                                    Save this code securely! You'll need it to approve transactions.
                                </p>
                            </div>
                        </div>
            ...
            {currentStep !== 'connect' && (
                <div className="mt-4 flex justify-center">
                    <div className="flex items-center space-x-2">
                        {['email', 'accountCode', 'deploying', 'complete'].map((step, i) => (
                            <div
                                key={step}
                                className={`h-2 w-2 rounded-full ${['email', 'accountCode', 'deploying', 'complete'].indexOf(currentStep as Step) >= i
